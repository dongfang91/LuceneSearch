...
//	
//	private static String csvTarget = "data/test_dev/input_1_cuiless_train.tsv";
...
//	private static String csvOutput = "output/test_dev/" + module +"PtUmls_train_40/";
...
private static String indexDirUmls = "index/umls/"+ module +"/";
private static String indexDirUmlsPt = "index/umls/"+ module +"Pt/";
private static String csvOutput = "output/train_for_bert/" + module +"PtUmls_train_40/";
...
//		results =  scoredEntries( groupingSearch,  searcherTrain,  SnameQueryParser,  escapedQueryString,40,"SEM_Train");
//		
//		if (results.isEmpty()) {
//	    	results =  scoredEntries( groupingSearch,  searcherTrain,  nameQueryParser,  escapedQueryString,40,"EM_Train");
//		}
		

    	results =  scoredEntries( groupingSearch,  searcherUmlsPt,  SnameQueryParser,  escapedQueryString,40,"SEM_UmlsPt");

		
		if (results.isEmpty()) {
	    	results =  scoredEntries( groupingSearch,  searcherUmlsPt,  nameQueryParser,  escapedQueryString,40,"EM_UmlsPt");
		}
		
		if (results.isEmpty()) {
    	results =  scoredEntries( groupingSearch,  searcherUmls,  nameQueryParser,  escapedQueryString,40,"EM_Umls");
		}
		
//		if (results.isEmpty()) {
//	    	results =  scoredEntries( groupingSearch,  searcherUmlsPt,  NameTokensQueryParser,  escapedQueryString,40);
//		}
...
//		if (results.isEmpty()) {
//	    	results =  scoredEntries( groupingSearch,  searcherUmlsPt,  nameQueryParser,  escapedQueryString +"~",40);
//		}
//	    
	    if (results.isEmpty()) { 
	        results = scoredEntries(groupingSearch,  searcherUmls,  nameQueryParser,  escapedQueryString +"~",40,"fuzzy_Umls" );
	  	    }
	    
	    if (results.isEmpty()) {
	    	results = scoredEntries(groupingSearch,  searcherUmls,  NgQueryParser,  escapedQueryString,40,"ngram_Umls");
	    }
